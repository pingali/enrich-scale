...
class QueryExecutorBase(Compute):
    ...
    def get_spec(self):
        """
        Get query execution specification. 
        """
        return []
    ...
    def get_executor(self, specitem, query, credentials):
        """
        Get executor for a specitem and credentials. Override this
        to provide your own executors...
        """
    ...
    def generator_daily(self, spec, specitem, query):
        """
        Generate a list of dates (one for each day) between
        two dates.
        """
